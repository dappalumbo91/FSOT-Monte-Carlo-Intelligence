...
# Prefer independent FSOT-MC vendor paths first
_MC_ROOT = Path(__file__).resolve().parents[2]  # .../FSOT-Monte-Carlo-Intelligence
ARCHIVE_COMPUTE_CANDIDATES = [
    _MC_ROOT / "fsot_mc" / "compute_authority.py",
    _MC_ROOT / "vendor" / "fsot_compute.py",
    _MC_ROOT / "vendor" / "archive_bundle" / "vendor__fsot_compute.py",
