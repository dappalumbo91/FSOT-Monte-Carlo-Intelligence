...
> **Tissue ID:** `dom_oncology` | **Kind:** Extension / validation panel  
> **Cluster / group:** `extension` | **Ring:** 4  
> **Authority:** D1D38A | **free_parameters:** 0 | **Generated:** 2026-07-23

## Abstract

Scientific tissue note for **oncology**, a Extension / validation panel in the FSOT domain map. Vitality scalar S=n/a at D_eff=12; regime **n/a**. Empirical panel median error not attached in compact tissue (n/a). This fold shares the single seed engine with cosmology, quantum, life, and engineering panels.
...
|--------|------|-------|----------|---------|
| [FSOT.Formal.OncologyPriors](domains/FSOT.Formal.OncologyPriors.md) | `coupling_crosswalk_module` | `archive_coupling` | 0.900 | 0.000000% |
