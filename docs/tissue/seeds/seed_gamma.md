# Seed γ — Euler–Mascheroni Harmonic Offset

> **Tissue ID:** `seed_gamma` | **Kind:** seed | **Symbol:** γ  
> **Authority:** D1D38A | **free_parameters:** 0 | **Generated:** 2026-07-23

## Abstract

This document is a miniature scientific thesis for the FSOT seed/law node **γ**.
...
**Numeric value:** `0.577215664901533`

### Derivations / appearances

- \(P_{\mathrm{base}} = \gamma/e\)
...
Sets overall scale of raw_S without free parameters.
