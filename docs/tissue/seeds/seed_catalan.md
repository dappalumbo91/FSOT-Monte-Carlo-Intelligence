# Seed G — Catalan Acoustic Constant

> **Tissue ID:** `seed_catalan` | **Kind:** seed | **Symbol:** G  
> **Authority:** D1D38A | **free_parameters:** 0 | **Generated:** 2026-07-23

## Abstract

This document is a miniature scientific thesis for the FSOT seed/law node **G**.
...
**Numeric value:** `0.915965594177219`

### Derivations / appearances

- \(C_{\mathrm{eff}} = (1 - \mathrm{Poof}\sin\theta_s)\,(1 + 0.01\,G/(\pi\varphi))\)
...
Fine structure of fluid efficiency and acoustic channel.
