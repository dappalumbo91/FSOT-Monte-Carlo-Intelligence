# Seed e — Natural Growth Base

> **Tissue ID:** `seed_e` | **Kind:** seed | **Symbol:** e  
> **Authority:** D1D38A | **free_parameters:** 0 | **Generated:** 2026-07-23

## Abstract

This document is a miniature scientific thesis for the FSOT seed/law node **e**.
...
**Numeric value:** `2.71828182845905`

### Derivations / appearances

- \(\psi_{\mathrm{con}} = 1 - e^{-1}\)
- Growth factor \(\exp(\alpha\cdot\ldots)\) in T1
- \(\mathrm{Poof} = \exp\bigl((-\ln\pi/e)/(\eta_{\mathrm{eff}}\ln\varphi)\bigr)\)
...
Growth vs decoherence balance; observer coupling scale.
