# PRED-178: D_H2Ol-H2Og

> **Tissue ID:** `pred_PRED-178` | **Kind:** preregistered prediction  
> **Domain:** `Nuclear_Physics` | **Branch:** `None`  
