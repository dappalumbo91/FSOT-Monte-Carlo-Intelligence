# PRED-017: Z119_Ti_Bk_heavy_ion_lab_synthesis

> **Tissue ID:** `pred_PRED-017` | **Kind:** preregistered prediction  
> **Domain:** `Heavy_Ion_Lab_Synthesis_Panel` | **Branch:** `term3.boundary_partition`  
...
| SOTA baseline | 0.0 |
| SOTA label | Z=119 not yet synthesized |
...
| Item | Value |
|------|------:|
| Predicted | 0.42 viability_score |
| Baseline | 0.0 (Z=119 not yet synthesized) |
