# PRED-013: unbihexium_Z126_island_stability

> **Tissue ID:** `pred_PRED-013` | **Kind:** preregistered prediction  
> **Domain:** `Undiscovered_Element_Candidate_Prereg_Scaffold` | **Branch:** `term1.term1_base`  
...
| Item | Value |
|------|------:|
| Predicted | 1200000000.0 half_life_s |
