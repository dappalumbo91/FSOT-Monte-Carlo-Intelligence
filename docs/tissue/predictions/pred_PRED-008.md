# PRED-008: phi_glass_Tg_morphogen_K

> **Tissue ID:** `pred_PRED-008` | **Kind:** preregistered prediction  
> **Domain:** `Phi_Morphogenetic_Scaling` | **Branch:** `term1.term1_base`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 199.0 |
| Unit | K |
| Formula branch | `term1.term1_base` |
| SOTA baseline | 210.0 |
| SOTA label | Polymer Tg phenomenology |
...
|------|------:|
| Predicted | 199.0 K |
| Baseline | 210.0 (Polymer Tg phenomenology) |
