# PRED-011: muon_catalyzed_dd_rate_bridge

> **Tissue ID:** `pred_PRED-011` | **Kind:** preregistered prediction  
> **Domain:** `Cold_Fusion_Candidate_Prereg_Scaffold` | **Branch:** `term1.initiation_transformation`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 108000000.0 |
| Unit | fusions/mol/s |
| Formula branch | `term1.initiation_transformation` |
| SOTA baseline | 100000000.0 |
| SOTA label | Published muon-catalyzed D-D rate |
...
| Item | Value |
|------|------:|
| Predicted | 108000000.0 fusions/mol/s |
| Baseline | 100000000.0 (Published muon-catalyzed D-D rate) |
