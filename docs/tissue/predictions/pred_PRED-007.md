# PRED-007: ionospheric_beta_quiet_classifier

> **Tissue ID:** `pred_PRED-007` | **Kind:** preregistered prediction  
> **Domain:** `Ionospheric_Chemistry_Coupling` | **Branch:** `term3.acoustic_inflow`  
...
| Formula branch | `term3.acoustic_inflow` |
| SOTA baseline | 0.55 |
| SOTA label | Dst-Kp decoupled heuristic |
...
| Item | Value |
|------|------:|
| Predicted | 1.0 stability_score |
| Baseline | 0.55 (Dst-Kp decoupled heuristic) |
