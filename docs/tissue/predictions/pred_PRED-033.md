# PRED-033: quantum_entanglement_gate_pair

> **Tissue ID:** `pred_PRED-033` | **Kind:** preregistered prediction  
> **Domain:** `Warp_BH_WH_Portal_Panel` | **Branch:** `term1.perceived_adjust`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 0.04803163401 |
| Unit | dimensionless_entanglement |
| Formula branch | `term1.perceived_adjust` |
| SOTA baseline | 0.0 |
| SOTA label | No paired-gate entanglement baseline |
...
| Item | Value |
|------|------:|
| Predicted | 0.04803163401 dimensionless_entanglement |
| Baseline | 0.0 (No paired-gate entanglement baseline) |
| Registered | 2026-07-10 |

### Notes

Value locked from legacy formula psi_entangle_gate at build time
