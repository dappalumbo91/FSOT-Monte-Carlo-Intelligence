# PRED-006: acoustic_impedance_median_MRayl

> **Tissue ID:** `pred_PRED-006` | **Kind:** preregistered prediction  
> **Domain:** `Acoustic_Resonance_Materials` | **Branch:** `term3.acoustic_bleed`  
...
| SOTA baseline | 0.45 |
| SOTA label | Empirical air-water impedance mean |
...
| Item | Value |
|------|------:|
| Predicted | 0.41 MRayl |
| Baseline | 0.45 (Empirical air-water impedance mean) |
