# PRED-002: S8_effective_lensing

> **Tissue ID:** `pred_PRED-002` | **Kind:** preregistered prediction  
> **Domain:** `Cosmology` | **Branch:** `term3.acoustic_bleed`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 0.805 |
| Unit | S8 |
| Formula branch | `term3.acoustic_bleed` |
| SOTA baseline | 0.834 |
| SOTA label | Planck2018 |
| Discriminant | `between_planck_and_des` |
