# PRED-038: transporter_portal_traverse_scalar

> **Tissue ID:** `pred_PRED-038` | **Kind:** preregistered prediction  
> **Domain:** `Star_Trek_Transporter_Live_Panel` | **Branch:** `term1.perceived_adjust`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 0.000464139486 |
| Unit | dimensionless_traverse |
| Formula branch | `term1.perceived_adjust` |
| SOTA baseline | 0.0 |
| SOTA label | No unified portal traverse baseline |
...
| Item | Value |
|------|------:|
| Predicted | 0.000464139486 dimensionless_traverse |
| Baseline | 0.0 (No unified portal traverse baseline) |
| Registered | 2026-07-15 |

### Notes

psi_traverse = psi_portal * psi_entangle — doorway step-through scalar from warp actuation
