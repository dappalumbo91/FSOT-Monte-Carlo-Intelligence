# PRED-004: muon_g2_excess_direction

> **Tissue ID:** `pred_PRED-004` | **Kind:** preregistered prediction  
> **Domain:** `Particle_Physics` | **Branch:** `term3.chaos_factor`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 2.49e-09 |
| Unit | delta_a_mu |
| Formula branch | `term3.chaos_factor` |
| SOTA baseline | 0.0 |
| SOTA label | SM_only |
| Discriminant | `same_sign_as_fermilab` |
...
| Item | Value |
|------|------:|
| Predicted | 2.49e-09 delta_a_mu |
| Baseline | 0.0 (SM_only) |
