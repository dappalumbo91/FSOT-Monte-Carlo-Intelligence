# PRED-005: lithium_problem_factor_bridge

> **Tissue ID:** `pred_PRED-005` | **Kind:** preregistered prediction  
> **Domain:** `Cosmology` | **Branch:** `term3.poof_factor`  
...
| Item | Value |
|------|------:|
| Predicted | 2.85 underproduction_factor |
| Baseline | 3.0 (BBN theory gap) |
