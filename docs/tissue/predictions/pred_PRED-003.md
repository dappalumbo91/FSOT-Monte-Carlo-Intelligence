# PRED-003: adversarial_codon_hole_rate

> **Tissue ID:** `pred_PRED-003` | **Kind:** preregistered prediction  
> **Domain:** `Code_Genome_Structure` | **Branch:** `term1.quirkMod`  
...
| FSOT predicted | 0.85 |
| Unit | fraction |
| Formula branch | `term1.quirkMod` |
| SOTA baseline | 0.35 |
| SOTA label | Semgrep heuristic hit rate |
...
| Item | Value |
|------|------:|
| Predicted | 0.85 fraction |
| Baseline | 0.35 (Semgrep heuristic hit rate) |
