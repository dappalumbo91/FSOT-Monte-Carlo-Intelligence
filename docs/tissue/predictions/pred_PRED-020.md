# PRED-020: Z126_N184_unbihexium_beam_synthesis

> **Tissue ID:** `pred_PRED-020` | **Kind:** preregistered prediction  
> **Domain:** `Z120_Z126_Beam_Synthesis_Panel` | **Branch:** `term3.boundary_partition`  
...
|-------|------:|
| FSOT predicted | 0.48 |
| Unit | viability_score |
| Formula branch | `term3.boundary_partition` |
| SOTA baseline | 0.0 |
| SOTA label | Z=126 not yet synthesized |
...
| Item | Value |
|------|------:|
| Predicted | 0.48 viability_score |
| Baseline | 0.0 (Z=126 not yet synthesized) |
