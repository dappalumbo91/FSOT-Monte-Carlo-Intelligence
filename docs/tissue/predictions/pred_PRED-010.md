# PRED-010: lattice_boundary_cold_fusion_channel

> **Tissue ID:** `pred_PRED-010` | **Kind:** preregistered prediction  
> **Domain:** `Cold_Fusion_Candidate_Prereg_Scaffold` | **Branch:** `term3.boundary_partition`  
...
| Item | Value |
|------|------:|
| Predicted | 1.62 enhancement_factor |
| Baseline | 0.0 (Null baseline) |
