# PRED-012: unbinilium_Z120_N184_half_life

> **Tissue ID:** `pred_PRED-012` | **Kind:** preregistered prediction  
> **Domain:** `Undiscovered_Element_Candidate_Prereg_Scaffold` | **Branch:** `term3.boundary_partition`  
...
| Item | Value |
|------|------:|
| Predicted | 2500000.0 half_life_s |
