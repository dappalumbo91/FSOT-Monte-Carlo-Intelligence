# PRED-036: fsot_transporter_technology_stack

> **Tissue ID:** `pred_PRED-036` | **Kind:** preregistered prediction  
> **Domain:** `Star_Trek_Transporter_Live_Panel` | **Branch:** `term3.poof_factor`  
...
| Field | Value |
|-------|------:|
| FSOT predicted | 0.05256 |
| Unit | pooled_median_error_pct |
| Formula branch | `term3.poof_factor` |
| SOTA baseline | 10.0 |
| SOTA label | Quantum teleportation + warp portal typical modeling gap |
...
| Item | Value |
|------|------:|
| Predicted | 0.05256 pooled_median_error_pct |
| Baseline | 10.0 (Quantum teleportation + warp portal typical modeling gap) |
| Registered | 2026-07-15 |

### Notes

FSOT transporter technology stack — warp actuation portal doorway (psi_portal, psi_traverse), entanglement gate pairs, poof/suction matter-stream, pattern-buffer/reassembly engineering observables verified against seed-scalar engine at sub-0.1% precision on portal channel.
