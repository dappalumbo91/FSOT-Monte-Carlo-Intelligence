# PRED-009: pd_deuterium_lattice_excess_heat

> **Tissue ID:** `pred_PRED-009` | **Kind:** preregistered prediction  
> **Domain:** `Cold_Fusion_Candidate_Prereg_Scaffold` | **Branch:** `term3.acoustic_bleed`  
...
|-------|------:|
| FSOT predicted | 1.85 |
| Unit | enhancement_factor |
| Formula branch | `term3.acoustic_bleed` |
| SOTA baseline | 0.0 |
| SOTA label | Null baseline (no reproducible excess heat) |
...
| Item | Value |
|------|------:|
| Predicted | 1.85 enhancement_factor |
| Baseline | 0.0 (Null baseline (no reproducible excess heat)) |
