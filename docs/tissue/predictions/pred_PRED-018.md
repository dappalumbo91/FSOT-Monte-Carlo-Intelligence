# PRED-018: pd_d_to_Z120_fusion_decay_cascade

> **Tissue ID:** `pred_PRED-018` | **Kind:** preregistered prediction  
> **Domain:** `Fusion_Decay_Chain_Prereg_Scaffold` | **Branch:** `term3.acoustic_bleed`  
