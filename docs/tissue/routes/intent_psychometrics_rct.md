# Problem Route: psychometrics rct

> **Tissue ID:** `intent_psychometrics_rct` | **Kind:** problem_route intent hub  
...
| [Psychology Psychometrics Depth Panel](domains/Psychology_Psychometrics_Depth_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
| [Neuroscience Connectomics Depth Panel](domains/Neuroscience_Connectomics_Depth_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
