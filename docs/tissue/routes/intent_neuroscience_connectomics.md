# Problem Route: neuroscience connectomics

> **Tissue ID:** `intent_neuroscience_connectomics` | **Kind:** problem_route intent hub  
...
| Field | Value |
|-------|-------|
| Intent | `neuroscience connectomics` |
| Core domain | `Neuroscience` |
...
|--------|------|-------|----------|---------|
| [Neuroscience](domains/Neuroscience.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
