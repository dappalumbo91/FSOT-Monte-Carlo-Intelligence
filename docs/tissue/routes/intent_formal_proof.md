# Problem Route: formal proof

> **Tissue ID:** `intent_formal_proof` | **Kind:** problem_route intent hub  
...
|--------|------|-------|----------|---------|
| [Pure Mathematics](domains/Pure_Mathematics.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
| [Certified Agent Formal Panel](domains/Certified_Agent_Formal_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
| [Rust Lean Bridge Panel](domains/Rust_Lean_Bridge_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
| [Early Lean MC Panel](domains/Early_Lean_MC_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
