# Problem Route: materials mechanics

> **Tissue ID:** `intent_materials_mechanics` | **Kind:** problem_route intent hub  
...
| [Materials Creep Fracture Depth Panel](domains/Materials_Creep_Fracture_Depth_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
