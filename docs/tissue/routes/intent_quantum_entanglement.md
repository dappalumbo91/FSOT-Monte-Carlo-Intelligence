# Problem Route: quantum entanglement

> **Tissue ID:** `intent_quantum_entanglement` | **Kind:** problem_route intent hub  
...
|--------|------|-------|----------|---------|
| [Quantum Mechanics](domains/Quantum_Mechanics.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
| [Quantum Mechanics Entanglement Depth Panel](domains/Quantum_Mechanics_Entanglement_Depth_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
| [Quantum Computing Math Depth Panel](domains/Quantum_Computing_Math_Depth_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
