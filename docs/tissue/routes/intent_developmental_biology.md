# Problem Route: developmental biology

> **Tissue ID:** `intent_developmental_biology` | **Kind:** problem_route intent hub  
...
| Field | Value |
|-------|-------|
| Intent | `developmental biology` |
| Core domain | `Biology` |
| Keywords | `developmental`, `embryogenesis`, `gestation`, `neurulation`, `structural biology` |
| Panels | `Biology_Developmental_Structural_Depth_Panel` |
...
|--------|------|-------|----------|---------|
| [Biology](domains/Biology.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
| [Biology Developmental Structural Depth Panel](domains/Biology_Developmental_Structural_Depth_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
