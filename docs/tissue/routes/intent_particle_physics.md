# Problem Route: particle physics

> **Tissue ID:** `intent_particle_physics` | **Kind:** problem_route intent hub  
...
| Field | Value |
|-------|-------|
| Intent | `particle physics` |
| Core domain | `Particle_Physics` |
...
|--------|------|-------|----------|---------|
| [Particle Physics](domains/Particle_Physics.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
| [Higgs Mass](domains/Higgs_Mass.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
