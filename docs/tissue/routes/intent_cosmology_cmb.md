# Problem Route: cosmology cmb

> **Tissue ID:** `intent_cosmology_cmb` | **Kind:** problem_route intent hub  
...
| Field | Value |
|-------|-------|
| Intent | `cosmology cmb` |
| Core domain | `Cosmology` |
...
|--------|------|-------|----------|---------|
| [Cosmology](domains/Cosmology.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
| [Cosmology Extended](domains/Cosmology_Extended.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
