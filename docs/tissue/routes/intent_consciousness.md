# Problem Route: consciousness

> **Tissue ID:** `intent_consciousness` | **Kind:** problem_route intent hub  
...
| Core domain | `Psychology` |
| Keywords | `consciousness`, `observer`, `microtubule`, `species` |
| Panels | `Observer_Effect_Cross_Species_Panel`, `Microtubule_Quantum_Consciousness_Panel`, `Consciousness_Species_Multi_Panel` |
...
|--------|------|-------|----------|---------|
| [Psychology](domains/Psychology.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
| [Observer Effect Cross Species Panel](domains/Observer_Effect_Cross_Species_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
| [Microtubule Quantum Consciousness Panel](domains/Microtubule_Quantum_Consciousness_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
| [Consciousness Species Multi Panel](domains/Consciousness_Species_Multi_Panel.md) | `problem_route` | `problem_intent` | 0.650 | n/a |
