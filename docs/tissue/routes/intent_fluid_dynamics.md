# Problem Route: fluid dynamics

> **Tissue ID:** `intent_fluid_dynamics` | **Kind:** problem_route intent hub  
...
| Field | Value |
|-------|-------|
| Intent | `fluid dynamics` |
| Core domain | `Fluid_Dynamics` |
| Keywords | `turbulence`, `navier`, `reynolds`, `cfd`, `fluid` |
| Panels | `Fluid_Dynamics` |
...
|--------|------|-------|----------|---------|
| [Fluid Dynamics](domains/Fluid_Dynamics.md) | `problem_route` | `problem_intent` | 0.850 | n/a |
