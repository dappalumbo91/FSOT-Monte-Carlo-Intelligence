...
ARXIV_CAT_TO_FSOT: dict[str, list[str]] = {
    "hep-th": ["Particle_Physics", "Quantum_Gravity", "Quantum_Mechanics"],
    "hep-ph": ["Particle_Physics", "High_Energy_Physics"],
    "hep-ex": ["Particle_Physics", "High_Energy_Physics"],
    "hep-lat": ["Particle_Physics", "Quantum_Mechanics"],
    ...
    "astro-ph.HE": ["Astrophysics", "High_Energy_Physics"],
    ...
    "physics.bio-ph": ["Biology", "Biophysics"],
    "physics.chem-ph": ["Chemistry", "Physical_Chemistry"],
    "physics.gen-ph": ["Cosmology", "Quantum_Mechanics"],
    "physics.class-ph": ["Mechanics", "Electromagnetism"],
    "q-bio": ["Biology", "Biochemistry"],
    "q-bio.NC": ["Neuroscience", "Biology"],
    "q-bio.BM": ["Biochemistry", "Biology"],
    "q-bio.GN": ["Biology", "Biochemistry"],
    "q-fin": ["Economics"],
    "stat.ML": ["Computer_Science", "Neuroscience"],
    "cs.AI": ["Computer_Science", "Neuroscience"],
    "cs.LG": ["Computer_Science"],
    "cs.CV": ["Computer_Science", "Optics"],
    "cs.CL": ["Computer_Science"],
    "cs.QC": ["Quantum_Computing", "Quantum_Mechanics"],
    "math-ph": ["Quantum_Mechanics", "Particle_Physics"],
    "math.MP": ["Quantum_Mechanics"],
    "nlin": ["Fluid_Dynamics"],
    "nlin.CD": ["Fluid_Dynamics"],
}
